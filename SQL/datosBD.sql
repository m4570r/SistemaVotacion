...
-- Insertar regiones en la tabla como_se_entero
INSERT INTO `region_cl` 
VALUES 	(1,'ARICA Y PARINACOTA','XV',2,4),
		(2,'TARAPACÁ','I',2,7),
...
-- Insertar provincias en la tabla provincias
INSERT INTO `provincia_cl` 
VALUES 	(1,1,'ARICA',2),
		(2,1,'PARINACOTA',2),
		(3,2,'IQUIQUE',2),
		(4,2,'TAMARUGAL',5),
...
-- Insertar comunas en la tabla comuna
INSERT INTO `comuna_cl` 
VALUES 	(1,1,'ARICA'),
		(2,1,'CAMARONES'),
		(3,2,'PUTRE'),
		(4,2,'GENERAL LAGOS'),
...
-- Insertar candidato en la tabla candidato
INSERT INTO candidato (id_candidato, nombre, apellido, partido_politico, eleccion_id)
VALUES  (1, 'Juan', 'Perez', 'Partido A', 1),
        (2, 'Maria', 'Gomez', 'Partido B', 2),
        (3, 'Carlos', 'Rodriguez', 'Partido C', 3),
        (4, 'Ana', 'Lopez', 'Partido D', 4);


-- Insertar opciones en la tabla como_se_entero
INSERT INTO como_se_entero (descripcion) 
VALUES  ('WEB'),
        ('TV'),
        ('RED SOCIAL'),
        ('AMIGO');
